...
subtitle: "ECCC contract no. 3000792304, deliverables 2 & 3"
...
```{r tube vs. no tube table, echo = FALSE, message = FALSE, fig.align='left'}
...
```{r tube vs. no tube table 2-5-1, echo = FALSE, message = FALSE, fig.align='left'}
...
```{r CCLO stopover maps, echo = FALSE, message = FALSE, warning = FALSE, fig.show = "hold", results = 'hide', fig.width=10, fig.height=8, fig.align='left', fig.cap="Figure 16. Possible stopover and overwintering locations for Chestnut-collared Longspur."}
...
ggplot(data = world) + 
  ...
  geom_segment(data = filter(plotDataCCLO, motusTagID == 67508), x = -102, y = 48.3, 
...
```{r HOLA stopover maps, echo = FALSE, message = FALSE, warning = FALSE, fig.show = "hold", results = 'hide', fig.width=10, fig.height=8, fig.align='left', fig.cap="Figure 17. Possible stopover and overwintering locations for Horned Lark."}
...
What time of day were GBMP tagged birds detected?

```{r time of day prep code, echo = FALSE, message = FALSE, warning = FALSE }
...
```{r time of day figure, echo = FALSE, message = FALSE, warning = FALSE, fig.show = "hold", results = 'hide', fig.width=10, fig.height=8, fig.align='left', fig.cap="Figure 19. Time of day of detections, by species. Civil twilight includes solar elevation angels of -6 to 0 radians, whereas solar elevation angles greater than 0 radians are considered daytime. Note that the y-axis scales vary by species."}
